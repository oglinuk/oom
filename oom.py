...
def main():
    ...
    while True:
        ...
        print()
        print('%s' % (str(_ipv4_omega2[0], 'UTF-8')))
        ...
        print('%s' % (str(_tx_bytes[0], 'UTF-8')))
        logger.info('%s' % (str(_tx_bytes[0], 'UTF-8')))
        print('%s' % (str(_tx_packets[0], 'UTF-8')))
        logger.info('%s' % (str(_tx_packets[0], 'UTF-8')))
        print('%s' % (str(_rx_bytes[0], 'UTF-8')))
        logger.info('%s' % (str(_rx_bytes[0], 'UTF-8')))
        print('%s' % (str(_rx_packets[0], 'UTF-8')))
